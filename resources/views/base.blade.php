...
<div id="header-wrapper">
	<div id="header" class="container">
		<div id="logo">
			<h1><span class="icon icon-cog"></span><a href="#">Nos vehicules</a></h1>
			<div id="menu">
				<ul>
					<li class="current_page_item"><a href="{{ route('welcome') }}" accesskey="1" title="">Homepage</a></li>
					<li><a href="{{ route('vehicules.index') }}" accesskey="2" title="">Nos vehicules</a></li>
					<li><a href="{{ route('careers') }}" accesskey="4" title="">Careers</a></li>
				</ul>
			</div>
		</div>
	</div>
